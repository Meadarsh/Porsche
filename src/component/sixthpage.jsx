...
const Sixthpage = () => {
  ...
  const select=['.white','.black','.red','.yellow','.metal-black','.grey','.navyblue','.maroon','.blue','.cream']
  ...
  return (
    <div className="sixth-main">
      <div className="image-contt">
       ...
       <BsArrowLeftCircle onClick={()=>{if(picIndex>1)setPicIndex(picIndex-1)}}/>
       <BsArrowRightCircle
          onClick={()=>{if(picIndex<6)setPicIndex(picIndex+1)}}/>
       </div>
        <img
      ...
      <div className="custom-main">
        ...
        <div>
          ...
          <p>Metalic Colors</p>
          <div  className="color-main">
            <div onClick={()=>setColor(5)} className=" metal-black color-box"></div>
            <div onClick={()=>setColor(6)} className="grey color-box"></div>
            <div onClick={()=>setColor(7)} className="navyblue color-box"></div>
          </div>
          <p>Special Colors</p>
          <div className="color-main">
